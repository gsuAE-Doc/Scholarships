...
<cfif isDefined("Form.instructions") or isDefined("URL.confirm")>
	...
	<cfif infotype eq "header"><h2></cfif>
  	<p valign="top"><b><script language="javascript">document.write(parent.parent.document.getElementById('new_custom_info').value);</script><cfif infotype neq "header">:</cfif></b>
	<cfif infotype eq "header"></h2></cfif>
