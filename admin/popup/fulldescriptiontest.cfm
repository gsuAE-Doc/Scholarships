...
<cfif isDefined("Form.full_description")>
	<cfoutput>
	<textarea>#Form.full_description#</textarea>
	...
	<!---<cfquery name="add" datasource="scholarships">
			update scholarships set full_desc=<CFQUERYPARAM VALUE="#Form.full_description#" CFSQLTYPE="CF_SQL_CLOB"> where scholarship_id=#Form.editschol#
		</cfquery>
...
<cfelse>
<form method="post" action="fulldescriptiontest.cfm">
